...
# $Id: gmo_movieplayer_README.txt,v 1.1 2004/10/07 13:12:38 essu Exp $
...
1. Versionen
 ...
 filebrowser.cpp, v. 1.91
 filebrowser.h,	  v. 1.33 
 movieplayer.cpp, v. 1.95
 movieplayer.h,   v. 1.19
 
 sollte mit CDKs ab 07/10/2004 kompilierbar sein und funktionieren.
 -> die oben aufgelisteten Dateien anstelle der Originale kopieren 
 (nach apps/tuxbox/neutrino/src/gui) und build durchfuehren.

 Die *.patch Dateien werden nur benoetigt, wenn die Aenderungen per 
 patch-Programm z.B. beim automatischen Bauen per yadi Scripts eingespielt
 werden sollen.
...
2.1 Live Streaming
 ...
 Zappen geht dann mit Hilfe des Filebrowser und Auswahl des entsprechenden
...
- Die Navigation innerhalb des Filebrowsers ist nun beschraenkt auf alle
  Verzeichnisse unterhalb (und inclusive) des Verzeichnisses, das in
  den Settings des movieplayers als Startverzeichnis angegeben ist.   
