...
#define cramfs_list_filename "squashfs.list"
#define local_cramfs_filename "update.squashfs"
...
bool CFlashUpdate::checkVersion4Update()
{
	...
	if (strcmp("1.8", versionInfo->getReleaseCycle()))
	{
		delete versionInfo;
...
int CFlashUpdate::exec(CMenuTarget* parent, const std::string &)
{
	...
	//image-check TODO: Was fuer squashfs basteln
